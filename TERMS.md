...
WireSpot runs as administrator and changes Windows networking while it operates. You are responsible for using it lawfully and for checking the rules of your internet service provider, VPN provider, employer, school, or other network owner before sharing a connection. You are responsible for securing the PC, your VPN keys, and your hotspot password.
...
The software and website are provided “as is,” without warranty, to the extent permitted by applicable law. The GPL's sections 15 and 16 set out the disclaimer of warranty and limitation of liability for the software. These terms do not add restrictions to, or reduce rights under, the GPL. The website and downloads may change or be unavailable.
...
Changes to these terms will appear here with a new effective date and version. For questions, open an issue at https://github.com/svyixiu/WireSpot/issues. Do not include passwords or private VPN keys in an issue.
